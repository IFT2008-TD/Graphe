...
TEST_F(GrapheTest, enumererSommetsArrivee_g2) {
    ...
    EXPECT_EQ(attendu, g_2.enumererSommetsPartantDe(1)) ;
    EXPECT_EQ(vide, g_2.enumererSommetsPartantDe(2)) ;
}

TEST_F(GrapheTest, enumererSommetsArrivee_g4) {
    Graphe<int>::ListeAdjacence attendu {3} ;
    EXPECT_EQ(attendu, g_4.enumererSommetsPartantDe(2)) ;
}
...
TEST_F(GrapheTest, enumererSommetsArrivee_inexistant_throw) {
    EXPECT_THROW(g_2.enumererSommetsPartantDe(10), std::invalid_argument) ;
    EXPECT_THROW(g_4.enumererSommetsPartantDe(-12), std::invalid_argument) ;
}
...
TEST_F(GrapheTest, ajouterUnSommet_g2) {
    ...
    EXPECT_EQ(vide, g_2.enumererSommetsPartantDe(3)) ;
...
TEST_F(GrapheTest, ajouterUneArete_g4) {
    ...
    EXPECT_EQ(1, g_4.degreEntree(2)) ;
    EXPECT_EQ(1, g_4.degreEntree(4)) ;
    EXPECT_EQ(arrivee1, g_4.enumererSommetsPartantDe(1)) ;
    EXPECT_EQ(arrivee3, g_4.enumererSommetsPartantDe(3)) ;
